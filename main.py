...
async def start_handler(_, event: Message):
	await event.reply_photo("https://telegra.ph/file/165941ae764a56d6d9c89.jpg",
                                ...
                                reply_markup=InlineKeyboardMarkup([
                                    [InlineKeyboardButton("Our Channel", url="https://t.me/anumitultrabots"),
...
async def help_handler(_, event: Message):
    ...
    await event.reply_text(Config.ABOUT_HELP_TEXT.format(event.from_user.mention),
        reply_markup=InlineKeyboardMarkup([
            [InlineKeyboardButton("Our Channel", url="https://t.me/anumitultrabots"),
             InlineKeyboardButton("Our Group", url="https://t.me/anumitultrabots"), 
             InlineKeyboardButton("About", callback_data="About_msg")]
        ])
    )
			...
			reply_markup=InlineKeyboardMarkup(
				[
					...
					[
						...
						InlineKeyboardButton("Channel", url="https://t.me/anumitultrabots")
					]
				]
			),
			parse_mode="html"
